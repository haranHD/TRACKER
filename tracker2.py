...
def Track():
    ...
    result = timezone.timezone(lng=location.longitude, lat=location.latitude)
...
# icon image
icon = tkinter.PhotoImage(file="C:\\Users\\haran\\Downloads\\logo image.png")
root.iconphoto(False, icon)

# logo
logo = PhotoImage(file="C:\\Users\\haran\\Downloads\\logo image.png")
Label(root, image=logo).place(x=240, y=70)

Eback = tkinter.PhotoImage(file="C:\\Users\\haran\\Downloads\\search png.png")
...
# bottom box
Box = PhotoImage(file="C:\\Users\\haran\\Downloads\\bottom png.png")
...
# search button
Search_image = PhotoImage(file="C:\\Users\\haran\\Downloads\\search.png")
